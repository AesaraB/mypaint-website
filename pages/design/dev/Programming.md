> :construction: _Get started:_ check out the [README](https://github.com/mypaint/mypaint/blob/master/README.md#build-and-install) for details of how to build & test MyPaint.  
